...
MapInsert(Characters,
	"acute", {
		...
		"asterisk_operator", {
			...
			show_on_fast_keys: True,
			alt_special: LeftControl LeftAlt " [Num/]",
			recipe: "^*",
		},
		"bullet_operator", {
			...
			group: [["Special Characters", "Smelting Special", "Special Fast"]],
			show_on_fast_keys: True,
			alt_special: LeftControl LeftAlt LeftShift " [Num/]",
			recipe: "^.",
		},
		"multiplication", {
...
MapInsert(Characters,
	...
	"lat_c_lig_aa", {
		...
		"lat_s_let_d_eth", {
			...
			titlesAlt: True,
			group: [["Latin Accented", "Latin Accented Secondary"]],
			tags: ["строчная буква эт", "small letter eth"],
			show_on_fast_keys: True,
			alt_on_fast_keys: "[d]",
			recipe: "$" GetChar("solidus_short"),
		},
...
ProcessMapAfter() {
	...
	for characterEntry, value in Characters {
		...
		if EntryExpression && HasProp(value, "alt_on_fast_keys") {
