...
MapInsert(Characters,
	...
	"lat_c_lig_aa", {
		...
		"glagolitic_c_let_small_yus", {
			...
			tags: ["прописная буква малый Юс глаголицы", "capital letter small letter Yus glagolitic"],
		},
		"glagolitic_s_let_small_yus", {
			...
			titlesAlt: True,
			group: ["Glagolitic Letters", "э"],
			tags: ["строчная буква малый юс глаголицы", "small letter small letter yus glagolitic"],
		},
		"glagolitic_c_let_small_yus_iotified", {
			...
			titlesAlt: True,
			group: ["Glagolitic Letters"],
			tags: ["прописная буква малый Юс йотированный глаголицы", "capital letter small letter Yus iotified glagolitic"],
			alt_layout: ">! [Э]",
		...
		"glagolitic_s_let_small_yus_iotified", {
			...
			titlesAlt: True,
			group: ["Glagolitic Letters"],
			tags: ["строчная буква малый юс йотированный глаголицы", "small letter small letter yus iotified glagolitic"],
			alt_layout: ">! [э]",
		...
		"glagolitic_c_let_big_yus", {
			...
			titlesAlt: True,
			group: ["Glagolitic Letters"],
			tags: ["прописная буква большой Юс глаголицы", "capital letter big Yus glagolitic"],
			alt_layout: "<! [О]",
		...
		"glagolitic_s_let_big_yus", {
			...
			titlesAlt: True,
			group: ["Glagolitic Letters"],
			tags: ["строчная буква большой юс глаголицы", "small letter big yus glagolitic"],
			alt_layout: "<! [о]",
			recipe: Chr(0x2C35) Chr(0x2C54),
		},
		"glagolitic_c_let_big_yus_iotified", {
			...
			titlesAlt: True,
			group: ["Glagolitic Letters"],
			tags: ["прописная буква большой Юс йотированный глаголицы", "capital letter big Yus iotified glagolitic"],
			alt_layout: "<! [Ё]",
		...
		"glagolitic_s_let_big_yus_iotified", {
			...
			titlesAlt: True,
			group: ["Glagolitic Letters"],
			tags: ["строчная буква большой юс йотированный глаголицы", "small letter big yus iotified glagolitic"],
			alt_layout: "<! [ё]",
...
GetKeyBindings(UseKey, Combinations := "FastKeys") {
	...
	if Combinations = "FastKeys" {
		FastArray := [
			...
			"<^>!" UseKey["4"], (K) => HandleFastKey(K, "division"),
		...
		if CyrillicLayout = "ЙЦУКЕН" {
			if LatinLayout = "QWERTY" {
				MapPush(Slots,
					...
					"<^>!J", ["glagolitic_c_let_otu", "glagolitic_s_let_otu"],
					"<!J", ["glagolitic_c_let_big_yus", "glagolitic_s_let_big_yus"],
					"K", ["glagolitic_c_let_ljudije", "glagolitic_s_let_ljudije"],
					"L", ["glagolitic_c_let_dobro", "glagolitic_s_let_dobro"],
					"M", ["glagolitic_c_let_yeri", "glagolitic_s_let_yeri"],
					"N", ["glagolitic_c_let_tvrido", "glagolitic_s_let_tvrido"],
					"O", ["glagolitic_c_let_shta", "glagolitic_s_let_shta"],
					"P", ["glagolitic_c_let_zemlja", "glagolitic_c_let_zemlja"],
					"Q", ["glagolitic_c_let_izhe", "glagolitic_s_let_izhe"],
					"R", ["glagolitic_c_let_kako", "glagolitic_s_let_kako"],
					"S", ["glagolitic_c_let_yery", "glagolitic_s_let_yery"],
					"T", ["glagolitic_c_let_yestu", "glagolitic_s_let_yestu"],
					"U", ["glagolitic_c_let_glagoli", "glagolitic_s_let_glagoli"],
					"V", ["glagolitic_c_let_myslite", "glagolitic_s_let_myslite"],
					"W", ["glagolitic_c_let_tsi", "glagolitic_s_let_tsi"],
					"X", ["glagolitic_c_let_chrivi", "glagolitic_s_let_chrivi"],
					"Y", ["glagolitic_c_let_nashi", "glagolitic_s_let_nashi"],
					"Z", ["glagolitic_c_let_yati", "glagolitic_s_let_yati"],
					",", ["glagolitic_c_let_buky", "glagolitic_s_let_buky"],
					"+,", ["cyr_c_let_b", "cyr_s_let_b"],
					".", ["glagolitic_c_let_yu", "glagolitic_s_let_yu"],
					"+.", ["cyr_c_let_yu", "cyr_s_let_yu"],
					";", ["glagolitic_c_let_zhivete", "glagolitic_s_let_zhivete"],
					"<^>!;", ["glagolitic_c_let_djervi", "glagolitic_s_let_djervi"],
					"'", ["glagolitic_c_let_small_yus", "glagolitic_s_let_small_yus"],
					"<^>!'", ["glagolitic_c_let_small_yus_iotified", "glagolitic_s_let_small_yus_iotified"],
					"[", ["glagolitic_c_let_heru", "glagolitic_s_let_heru"],
					"<^>![", ["glagolitic_c_let_spider_ha", "glagolitic_s_let_spider_ha"],
					"]", ["glagolitic_c_let_yeru", "glagolitic_s_let_yeru"],
					"<^>!]", ["glagolitic_c_let_shtapic", "glagolitic_s_let_shtapic"],
					"~", ["glagolitic_c_let_yo", "glagolitic_s_let_yo"],
				...
				MapPush(Slots,
					"A", ["glagolitic_c_let_fritu", "glagolitic_s_let_fritu"],
					"<^>!A", ["glagolitic_c_let_fita", "glagolitic_s_let_fita"],
					"X", ["glagolitic_c_let_i", "glagolitic_s_let_i"],
					"<^>!X", ["glagolitic_c_let_initial_izhe", "glagolitic_s_let_initial_izhe"],
					"<+X", ["glagolitic_c_let_izhe", "glagolitic_s_let_izhe"],
					"<^>!<+X", ["glagolitic_c_let_izhitsa", "glagolitic_s_let_izhitsa"],
					"J", ["glagolitic_c_let_slovo", "glagolitic_s_let_slovo"],
					"<^>!J", ["glagolitic_c_let_dzelo", "glagolitic_s_let_dzelo"],
					"E", ["glagolitic_c_let_vede", "glagolitic_s_let_vede"],
					".", ["glagolitic_c_let_uku", "glagolitic_s_let_uku"],
					"U", ["glagolitic_c_let_az", "glagolitic_s_let_az"],
					"<^>!U", ["glagolitic_c_let_trokutasti_a", "glagolitic_s_let_trokutasti_a"],
					"I", ["glagolitic_c_let_pokoji", "glagolitic_s_let_pokoji"],
					"<^>!I", ["glagolitic_c_let_pe", "glagolitic_s_let_pe"],
					"D", ["glagolitic_c_let_ritsi", "glagolitic_s_let_ritsi"],
					"C", ["glagolitic_c_let_sha", "glagolitic_s_let_sha"],
					"H", ["glagolitic_c_let_onu", "glagolitic_s_let_onu"],
					"<^>!H", ["glagolitic_c_let_otu", "glagolitic_s_let_otu"],
					"<!H", ["glagolitic_c_let_big_yus", "glagolitic_s_let_big_yus"],
					"T", ["glagolitic_c_let_ljudije", "glagolitic_s_let_ljudije"],
					"N", ["glagolitic_c_let_dobro", "glagolitic_s_let_dobro"],
					"M", ["glagolitic_c_let_yeri", "glagolitic_s_let_yeri"],
					"B", ["glagolitic_c_let_tvrido", "glagolitic_s_let_tvrido"],
					"R", ["glagolitic_c_let_shta", "glagolitic_s_let_shta"],
					"L", ["glagolitic_c_let_zemlja", "glagolitic_c_let_zemlja"],
					"'", ["glagolitic_c_let_izhe", "glagolitic_s_let_izhe"],
					"P", ["glagolitic_c_let_kako", "glagolitic_s_let_kako"],
					"O", ["glagolitic_c_let_yery", "glagolitic_s_let_yery"],
					"Y", ["glagolitic_c_let_yestu", "glagolitic_s_let_yestu"],
					"G", ["glagolitic_c_let_glagoli", "glagolitic_s_let_glagoli"],
					"K", ["glagolitic_c_let_myslite", "glagolitic_s_let_myslite"],
					",", ["glagolitic_c_let_tsi", "glagolitic_s_let_tsi"],
					"Q", ["glagolitic_c_let_chrivi", "glagolitic_s_let_chrivi"],
					"F", ["glagolitic_c_let_nashi", "glagolitic_s_let_nashi"],
					";", ["glagolitic_c_let_yati", "glagolitic_s_let_yati"],
					"W", ["glagolitic_c_let_buky", "glagolitic_s_let_buky"],
					"+W", ["cyr_c_let_b", "cyr_s_let_b"],
					"V", ["glagolitic_c_let_yu", "glagolitic_s_let_yu"],
					"+V", ["cyr_c_let_yu", "cyr_s_let_yu"],
					"S", ["glagolitic_c_let_zhivete", "glagolitic_s_let_zhivete"],
					"<^>!S", ["glagolitic_c_let_djervi", "glagolitic_s_let_djervi"],
					"-", ["glagolitic_c_let_small_yus", "glagolitic_s_let_small_yus"],
					"<^>!-", ["glagolitic_c_let_small_yus_iotified", "glagolitic_s_let_small_yus_iotified"],
					"/", ["glagolitic_c_let_heru", "glagolitic_s_let_heru"],
					"<^>!/", ["glagolitic_c_let_spider_ha", "glagolitic_s_let_spider_ha"],
			...
			if LatinLayout = "QWERTY" {
				...
				MapPush(Slots,
					"A", ["cyr_c_let_u", "cyr_s_let_u"],
					"X", ["cyr_c_let_yu", "cyr_s_let_yu"],
					"J", ["cyr_c_let_h", "cyr_s_let_h"],
					"E", ["cyr_c_let_e", "cyr_s_let_e"],
					".", ["cyr_c_let_ya", "cyr_s_let_ya"],
					"U", ["cyr_c_let_o", "cyr_s_let_o"],
					"I", ["cyr_c_let_a", "cyr_s_let_a"],
					"D", ["cyr_c_let_l", "cyr_s_let_l"],
					"C", ["cyr_c_let_k", "cyr_s_let_k"],
					"H", ["cyr_c_let_n", "cyr_s_let_n"],
					"T", ["cyr_c_let_t", "cyr_s_let_t"],
					"N", ["cyr_c_let_s", "cyr_s_let_s"],
					"M", ["cyr_c_let_m", "cyr_s_let_m"],
					"B", ["cyr_c_let_b", "cyr_s_let_b"],
					"R", ["cyr_c_let_d", "cyr_s_let_d"],
					"L", ["cyr_c_let_ch", "cyr_s_let_ch"],
					"'", ["cyr_c_let_ts", "cyr_s_let_ts"],
					"P", "kkey_comma",
					"+P", "question",
					"O", ["cyr_c_let_и", "cyr_s_let_и"],
					"Y", "kkey_dot",
					"+Y", "exclamation",
					"G", ["cyr_c_let_v", "cyr_s_let_v"],
					"K", ["cyr_c_let_yery", "cyr_s_let_yery"],
					",", ["cyr_c_let_yeri", "cyr_s_let_yeri"],
					"+,", ["cyr_s_let_yeru", "cyr_c_let_yeru"],
					"Q", ["cyr_c_let_э", "cyr_s_let_э"],
					"F", ["cyr_c_let_z", "cyr_s_let_z"],
					";", ["cyr_c_let_f", "cyr_s_let_f"],
					"W", ["cyr_c_let_p", "cyr_s_let_p"],
					"V", ["cyr_c_let_g", "cyr_s_let_g"],
					"S", ["cyr_c_let_r", "cyr_s_let_r"],
					"-", ["cyr_c_let_iy", "cyr_s_let_iy"],
					"/", ["cyr_c_let_sh", "cyr_s_let_sh"],
					"=", ["cyr_c_let_shch", "cyr_s_let_shch"],
					"~", ["cyr_c_let_yo", "cyr_s_let_yo"],
					"Z", ["cyr_c_let_zh", "cyr_s_let_zh"],
					"\", "kkey_slash",
					"+\", "kkey_backslash",
					"]", "kkey_equals",
					"+]", "kkey_plus",
				...
				MapPush(Slots,
					...
					"B", ["cyr_c_let_yu", "cyr_s_let_yu"],
					"C", ["cyr_c_let_h", "cyr_s_let_h"],
					"S", ["cyr_c_let_e", "cyr_s_let_e"],
					"F", ["cyr_c_let_ya", "cyr_s_let_ya"],
					"T", ["cyr_c_let_o", "cyr_s_let_o"],
					"D", ["cyr_c_let_a", "cyr_s_let_a"],
					"H", ["cyr_c_let_l", "cyr_s_let_l"],
					"U", ["cyr_c_let_k", "cyr_s_let_k"],
					"N", ["cyr_c_let_n", "cyr_s_let_n"],
					"E", ["cyr_c_let_t", "cyr_s_let_t"],
					"I", ["cyr_c_let_s", "cyr_s_let_s"],
					"M", ["cyr_c_let_m", "cyr_s_let_m"],
					"K", ["cyr_c_let_b", "cyr_s_let_b"],
					"Y", ["cyr_c_let_d", "cyr_s_let_d"],
					";", ["cyr_c_let_ch", "cyr_s_let_ch"],
					"Q", ["cyr_c_let_ts", "cyr_s_let_ts"],
					"P", "kkey_comma",
					"+P", "question",
					"R", ["cyr_c_let_и", "cyr_s_let_и"],
					"G", "kkey_dot",
					"+G", "exclamation",
					"L", ["cyr_c_let_v", "cyr_s_let_v"],
					"V", ["cyr_c_let_yery", "cyr_s_let_yery"],
					"W", ["cyr_c_let_yeri", "cyr_s_let_yeri"],
					"+W", ["cyr_s_let_yeru", "cyr_c_let_yeru"],
					"X", ["cyr_c_let_э", "cyr_s_let_э"],
					"J", ["cyr_c_let_z", "cyr_s_let_z"],
					"Z", ["cyr_c_let_f", "cyr_s_let_f"],
					",", ["cyr_c_let_p", "cyr_s_let_p"],
					".", ["cyr_c_let_g", "cyr_s_let_g"],
					"O", ["cyr_c_let_r", "cyr_s_let_r"],
					"'", ["cyr_c_let_iy", "cyr_s_let_iy"],
					"[", ["cyr_c_let_sh", "cyr_s_let_sh"],
					"+[", ["cyr_c_let_sh", "cyr_s_let_sh"],
					"]", ["cyr_c_let_shch", "cyr_s_let_shch"],
		...
		SlotModdedMapping := Map(
			...
			"C", Map("<^>!<!", "medieval_c"),
			"D", Map("<^>!", "futhark_younger_later_eth", "<^>!<+", "futhark_younger_later_d"),
		...
		LayoutArray := [
			...
			"<!" UseKey["Tilde"], (K) => LangSeparatedKey(K, "", SlotMod("~", "<!"), True),
			UseKey["Comma"], (K) => LangSeparatedKey(K, "kkey_comma", Slots[","], True),
			UseKey["Dot"], (K) => LangSeparatedKey(K, "kkey_dot", Slots["."], True),
			"<^>!" UseKey["Comma"], (K) => LangSeparatedKey(K, "runic_cruciform_punctuation", SlotMod(",", "<^>!"), True),
			"<^>!" UseKey["Dot"], (K) => LangSeparatedKey(K, "runic_single_punctuation", SlotMod(".", "<^>!"), True),
			...
			"<^>!" UseKey["Semicolon"], (K) => LangSeparatedKey(K, "kkey_semicolon", SlotMod(";", "<^>!"), True),
			UseKey["Apostrophe"], (K) => LangSeparatedKey(K, "kkey_apostrophe", Slots["'"], True),
			"<^>!" UseKey["Apostrophe"], (K) => LangSeparatedKey(K, "kkey_apostrophe", SlotMod("'", "<^>!"), True),
			UseKey["LSquareBracket"], (K) => LangSeparatedKey(K, "kkey_l_square_bracket", Slots["["], True),
			"<^>!" UseKey["LSquareBracket"], (K) => LangSeparatedKey(K, "", SlotMod("[", "<^>!"), True),
			UseKey["RSquareBracket"], (K) => LangSeparatedKey(K, "kkey_r_square_bracket", Slots["]"], True),
			"<^>!" UseKey["RSquareBracket"], (K) => LangSeparatedKey(K, "", SlotMod("]", "<^>!"), True),
			;
			UseKey["Equals"], (K) => LangSeparatedKey(K, "kkey_equals", Slots["="], True),
			"+" UseKey["Equals"], (K) => LangSeparatedKey(K, "kkey_plus", SlotMod("="), True, True),
			UseKey["Minus"], (K) => LangSeparatedKey(K, "kkey_hyphen_minus", Slots["-"], True),
			"+" UseKey["Minus"], (K) => LangSeparatedKey(K, "kkey_underscore", SlotMod("-"), True, True),
			UseKey["Slash"], (K) => LangSeparatedKey(K, "kkey_slash", Slots["/"], True),
			"+" UseKey["Slash"], (K) => LangSeparatedKey(K, "question", SlotMod("/"), True, True),
			UseKey["Backslash"], (K) => LangSeparatedKey(K, "kkey_backslash", Slots["\"], True),
			"+" UseKey["Backslash"], (K) => LangSeparatedKey(K, "kkey_verticalline", SlotMod("\"), True, True),
			;
		...
		LayoutArray2 := [
			UseKey["A"], (K) => LangSeparatedKey(K, "futhark_ansuz", Slots["A"], True),
			"<!" UseKey["A"], (K) => LangSeparatedKey(K, "", SlotMod("A", "<!"), True),
			"<+" UseKey["A"], (K) => LangSeparatedKey(K, "futhork_as", SlotMod("A", "<+"), True),
			">+" UseKey["A"], (K) => LangSeparatedKey(K, "futhork_aesc", SlotMod("A", ">+"), True),
			"<^>!" UseKey["A"], (K) => LangSeparatedKey(K, "futhark_younger_jera", SlotMod("A", "<^>!"), True),
			"<^>!<+" UseKey["A"], (K) => LangSeparatedKey(K, "futhark_younger_jera_short_twig", SlotMod("A", "<^>!<+"), True),
			"<^>!<!" UseKey["A"], (K) => LangSeparatedKey(K, "", SlotMod("A", "<^>!<!"), True),
			"<^>!<!>+" UseKey["A"], (K) => LangSeparatedKey(K, "", SlotMod("A", "<^>!<!>+"), True),
			UseKey["B"], (K) => LangSeparatedKey(K, "futhark_berkanan", Slots["B"], True),
			"<!" UseKey["B"], (K) => LangSeparatedKey(K, "", SlotMod("B", "<!"), True),
			"<+" UseKey["B"], (K) => LangSeparatedKey(K, "", SlotMod("B", "<+"), True),
			">+" UseKey["B"], (K) => LangSeparatedKey(K, "", SlotMod("B", "<+"), True),
			"<^>!" UseKey["B"], (K) => LangSeparatedKey(K, "", SlotMod("B", "<^>!"), True),
			"<^>!<+" UseKey["B"], (K) => LangSeparatedKey(K, "futhark_younger_bjarkan_short_twig", SlotMod("B", "<^>!<!"), True),
			"<^>!<!" UseKey["B"], (K) => LangSeparatedKey(K, "", SlotMod("B", "<^>!<!>+"), True),
			"<^>!<!>+" UseKey["B"], (K) => LangSeparatedKey(K, "", SlotMod("B", "<^>!<+"), True),
			UseKey["C"], (K) => LangSeparatedKey(K, "futhork_cen", Slots["C"], True),
			"<!" UseKey["C"], (K) => LangSeparatedKey(K, "", SlotMod("C", "<!"), True),
			"<+" UseKey["C"], (K) => LangSeparatedKey(K, "", SlotMod("C", "<+"), True),
			">+" UseKey["C"], (K) => LangSeparatedKey(K, "", SlotMod("C", ">+"), True),
			"<^>!" UseKey["C"], (K) => LangSeparatedKey(K, "", SlotMod("C", "<^>!"), True),
			"<^>!<+" UseKey["C"], (K) => LangSeparatedKey(K, "", SlotMod("C", "<^>!<+"), True),
			"<^>!<!" UseKey["C"], (K) => LangSeparatedKey(K, "medieval_c", SlotMod("C", "<^>!<!"), True),
			"<^>!<!>+" UseKey["C"], (K) => LangSeparatedKey(K, "", SlotMod("C", "<^>!<!>+"), True),
			UseKey["D"], (K) => LangSeparatedKey(K, "futhark_dagaz", Slots["D"], True),
			"<!" UseKey["D"], (K) => LangSeparatedKey(K, "", SlotMod("D", "<!"), True),
			"<+" UseKey["D"], (K) => LangSeparatedKey(K, "", SlotMod("D", "<+"), True),
			">+" UseKey["D"], (K) => LangSeparatedKey(K, "", SlotMod("D", ">+"), True),
			"<^>!" UseKey["D"], (K) => LangSeparatedKey(K, "futhark_younger_later_eth", SlotMod("D", "<^>!"), True),
			"<^>!<+" UseKey["D"], (K) => LangSeparatedKey(K, "futhark_younger_later_d", SlotMod("D", "<^>!<+"), True),
			"<^>!<!" UseKey["D"], (K) => LangSeparatedKey(K, "", SlotMod("D", "<^>!<!"), True),
			"<^>!<!>+" UseKey["D"], (K) => LangSeparatedKey(K, "", SlotMod("D", "<^>!<!>+"), True),
			UseKey["E"], (K) => LangSeparatedKey(K, "futhark_ehwaz", Slots["E"], True),
			"<!" UseKey["E"], (K) => LangSeparatedKey(K, "futhork_ear", SlotMod("E", "<!"), True),
			"<+" UseKey["E"], (K) => LangSeparatedKey(K, "futhork_ear", SlotMod("E", "<+"), True),
			">+" UseKey["E"], (K) => LangSeparatedKey(K, "", SlotMod("E", ">+"), True),
			"<^>!" UseKey["E"], (K) => LangSeparatedKey(K, "futhark_younger_later_e", SlotMod("E", "<^>!"), True),
			"<^>!<+" UseKey["E"], (K) => LangSeparatedKey(K, "", SlotMod("E", "<^>!<+"), True),
			"<^>!<!" UseKey["E"], (K) => LangSeparatedKey(K, "medieval_en", SlotMod("E", "<^>!<!"), True),
			"<^>!<!>+" UseKey["E"], (K) => LangSeparatedKey(K, "", SlotMod("E", "<^>!<!>+"), True),
			UseKey["F"], (K) => LangSeparatedKey(K, "futhark_fehu", Slots["F"], True),
			"<!" UseKey["F"], (K) => LangSeparatedKey(K, "", SlotMod("F", "<!"), True),
			"<+" UseKey["F"], (K) => LangSeparatedKey(K, "", SlotMod("F", "<+"), True),
			">+" UseKey["F"], (K) => LangSeparatedKey(K, "", SlotMod("F", "<+"), True),
			"<^>!" UseKey["F"], (K) => LangSeparatedKey(K, "", SlotMod("F", "<^>!"), True),
			"<^>!<+" UseKey["F"], (K) => LangSeparatedKey(K, "", SlotMod("F", "<^>!<+"), True),
			"<^>!<!" UseKey["F"], (K) => LangSeparatedKey(K, "", SlotMod("F", "<^>!<!"), True),
			"<^>!<!>+" UseKey["F"], (K) => LangSeparatedKey(K, "", SlotMod("F", "<^>!<!>+"), True),
			UseKey["G"], (K) => LangSeparatedKey(K, "futhark_gebo", Slots["G"], True),
			"<!" UseKey["G"], (K) => LangSeparatedKey(K, "futhork_gar", SlotMod("G", "<!"), True),
			"<+" UseKey["G"], (K) => LangSeparatedKey(K, "futhork_gar", SlotMod("G", "<+"), True),
			">+" UseKey["G"], (K) => LangSeparatedKey(K, "", SlotMod("G", ">+"), True),
			"<^>!" UseKey["G"], (K) => LangSeparatedKey(K, "", SlotMod("G", "<^>!"), True),
			"<^>!<+" UseKey["G"], (K) => LangSeparatedKey(K, "", SlotMod("G", "<^>!<+"), True),
			"<^>!<!" UseKey["G"], (K) => LangSeparatedKey(K, "", SlotMod("G", "<^>!<!"), True),
			"<^>!<!>+" UseKey["G"], (K) => LangSeparatedKey(K, "", SlotMod("G", "<^>!<!>+"), True),
			UseKey["H"], (K) => LangSeparatedKey(K, "futhark_haglaz", Slots["H"], True),
			"<!" UseKey["H"], (K) => LangSeparatedKey(K, "futhork_haegl", SlotMod("H", "<!"), True),
			"<+" UseKey["H"], (K) => LangSeparatedKey(K, "futhork_haegl", SlotMod("H", "<+"), True),
			">+" UseKey["H"], (K) => LangSeparatedKey(K, "futhork_haegl", SlotMod("H", ">+"), True),
			"<^>!" UseKey["H"], (K) => LangSeparatedKey(K, "futhark_younger_hagall", SlotMod("H", "<^>!"), True),
			"<^>!<+" UseKey["H"], (K) => LangSeparatedKey(K, "futhark_younger_hagall_short_twig", SlotMod("H", "<^>!<+"), True),
			"<^>!<!" UseKey["H"], (K) => LangSeparatedKey(K, "", SlotMod("H", "<^>!<!"), True),
			"<^>!<!>+" UseKey["H"], (K) => LangSeparatedKey(K, "", SlotMod("H", "<^>!<!>+"), True),
			UseKey["I"], (K) => LangSeparatedKey(K, "futhark_isaz", Slots["I"], True),
			"<!" UseKey["I"], (K) => LangSeparatedKey(K, "", SlotMod("G", "<!"), True),
			"<+" UseKey["I"], (K) => LangSeparatedKey(K, "", SlotMod("G", "<+"), True),
			">+" UseKey["I"], (K) => LangSeparatedKey(K, "futhark_eihwaz", SlotMod("G", ">+"), True),
			"<^>!" UseKey["I"], (K) => LangSeparatedKey(K, "", SlotMod("G", "<^>!"), True),
			"<^>!<+" UseKey["I"], (K) => LangSeparatedKey(K, "", SlotMod("G", "<^>!<+"), True),
			"<^>!<!" UseKey["I"], (K) => LangSeparatedKey(K, "", SlotMod("G", "<^>!<!"), True),
			"<^>!<!>+" UseKey["I"], (K) => LangSeparatedKey(K, "", SlotMod("G", "<^>!<!>+"), True),
			...
			"<!" UseKey["K"], (K) => LangSeparatedKey(K, "", SlotMod("K", "<!"), True),
			"<+" UseKey["K"], (K) => LangSeparatedKey(K, "futhork_cealc", SlotMod("K", "<+"), True),
			">+" UseKey["K"], (K) => LangSeparatedKey(K, "futhork_calc", SlotMod("K", ">+"), True),
			"<^>!" UseKey["K"], (K) => LangSeparatedKey(K, "futhark_younger_kaun", SlotMod("K", "<^>!"), True),
			"<^>!<+" UseKey["K"], (K) => LangSeparatedKey(K, "futhark_younger_kaun", SlotMod("K", "<^>!<+"), True),
			...
			"<!" UseKey["L"], (K) => LangSeparatedKey(K, "", SlotMod("K", "<!"), True),
			"<+" UseKey["L"], (K) => LangSeparatedKey(K, "", SlotMod("K", "<+"), True),
			">+" UseKey["L"], (K) => LangSeparatedKey(K, "", SlotMod("K", ">+"), True),
			"<^>!" UseKey["L"], (K) => LangSeparatedKey(K, "futhark_younger_later_l", SlotMod("K", "<^>!"), True),
			"<^>!<+" UseKey["L"], (K) => LangSeparatedKey(K, "", SlotMod("K", "<^>!<+"), True),
			"<^>!<!" UseKey["L"], (K) => LangSeparatedKey(K, "", SlotMod("K", "<^>!<!"), True),
			"<^>!<!>+" UseKey["L"], (K) => LangSeparatedKey(K, "", SlotMod("K", "<^>!<!>+"), True),
			UseKey["M"], (K) => LangSeparatedKey(K, "futhark_mannaz", Slots["M"], True),
			"<!" UseKey["M"], (K) => LangSeparatedKey(K, "", SlotMod("M", "<!"), True),
			"<+" UseKey["M"], (K) => LangSeparatedKey(K, "", SlotMod("M", "<+"), True),
			">+" UseKey["M"], (K) => LangSeparatedKey(K, "", SlotMod("M", ">+"), True),
			"<^>!" UseKey["M"], (K) => LangSeparatedKey(K, "futhark_younger_madr", SlotMod("M", "<^>!"), True),
			"<^>!<+" UseKey["M"], (K) => LangSeparatedKey(K, "futhark_younger_madr_short_twig", SlotMod("M", "<^>!<+"), True),
			...
			"<!" UseKey["N"], (K) => LangSeparatedKey(K, "", SlotMod("N", "<!"), True),
			"<+" UseKey["N"], (K) => LangSeparatedKey(K, "futhork_ing", SlotMod("N", "<+"), True),
			">+" UseKey["N"], (K) => LangSeparatedKey(K, "futhark_ingwaz", SlotMod("N", ">+"), True),
			"<^>!" UseKey["N"], (K) => LangSeparatedKey(K, "", SlotMod("N", "<^>!"), True),
			"<^>!<+" UseKey["N"], (K) => LangSeparatedKey(K, "futhark_younger_naud_short_twig", SlotMod("N", "<^>!<+"), True),
			...
			"<!" UseKey["O"], (K) => LangSeparatedKey(K, "", SlotMod("O", "<!"), True),
			"<+" UseKey["O"], (K) => LangSeparatedKey(K, "futhork_os", SlotMod("O", "<+"), True),
			">+" UseKey["O"], (K) => LangSeparatedKey(K, "", SlotMod("O", "Ю+"), True),
			"<^>!" UseKey["O"], (K) => LangSeparatedKey(K, "futhark_younger_oss", SlotMod("O", "<^>!"), True),
			"<^>!<+" UseKey["O"], (K) => LangSeparatedKey(K, "futhark_younger_oss_short_twig", SlotMod("O", "<^>!<+"), True),
			"<^>!<!" UseKey["O"], (K) => LangSeparatedKey(K, "medieval_on", SlotMod("O", "<^>!<!"), True),
			"<^>!<!>+" UseKey["O"], (K) => LangSeparatedKey(K, "medieval_o", SlotMod("O", "<^>!<!>+"), True),
			...
			"<^>!" UseKey["P"], (K) => LangSeparatedKey(K, "futhark_younger_later_p", SlotMod("P", "<^>!"), True),
			"<+" UseKey["P"], (K) => LangSeparatedKey(K, "", SlotMod("P", "<+"), True),
			">+" UseKey["P"], (K) => LangSeparatedKey(K, "", SlotMod("P", ">+"), True),
		...
		LayoutArray := [
			...
			"+" UseKey["A"], (K) => LangSeparatedKey(K, ["lat_c_let_a", "lat_s_let_a"], SlotMod("A"), True, True),
			UseKey["B"], (K) => LangSeparatedKey(K, ["lat_c_let_b", "lat_s_let_b"], Slots["B"], True),
			"+" UseKey["B"], (K) => LangSeparatedKey(K, ["lat_c_let_b", "lat_s_let_b"], SlotMod("B"), True, True),
			UseKey["C"], (K) => LangSeparatedKey(K, ["lat_c_let_c", "lat_s_let_c"], Slots["C"], True),
			"+" UseKey["C"], (K) => LangSeparatedKey(K, ["lat_c_let_c", "lat_s_let_c"], SlotMod("C"), True, True),
			UseKey["D"], (K) => LangSeparatedKey(K, ["lat_c_let_d", "lat_s_let_d"], Slots["D"], True),
			"+" UseKey["D"], (K) => LangSeparatedKey(K, ["lat_c_let_d", "lat_s_let_d"], SlotMod("D"), True, True),
			UseKey["E"], (K) => LangSeparatedKey(K, ["lat_c_let_e", "lat_s_let_e"], Slots["E"], True),
			"+" UseKey["E"], (K) => LangSeparatedKey(K, ["lat_c_let_e", "lat_s_let_e"], SlotMod("E"), True, True),
			UseKey["F"], (K) => LangSeparatedKey(K, ["lat_c_let_f", "lat_s_let_f"], Slots["F"], True),
			"+" UseKey["F"], (K) => LangSeparatedKey(K, ["lat_c_let_f", "lat_s_let_f"], SlotMod("F"), True, True),
			UseKey["G"], (K) => LangSeparatedKey(K, ["lat_c_let_g", "lat_s_let_g"], Slots["G"], True),
			"+" UseKey["G"], (K) => LangSeparatedKey(K, ["lat_c_let_g", "lat_s_let_g"], SlotMod("G"), True, True),
			UseKey["H"], (K) => LangSeparatedKey(K, ["lat_c_let_h", "lat_s_let_h"], Slots["H"], True),
			"+" UseKey["H"], (K) => LangSeparatedKey(K, ["lat_c_let_h", "lat_s_let_h"], SlotMod("H"), True, True),
			UseKey["I"], (K) => LangSeparatedKey(K, ["lat_c_let_i", "lat_s_let_i"], Slots["I"], True),
			"+" UseKey["I"], (K) => LangSeparatedKey(K, ["lat_c_let_i", "lat_s_let_i"], SlotMod("I"), True, True),
			UseKey["J"], (K) => LangSeparatedKey(K, ["lat_c_let_j", "lat_s_let_j"], Slots["J"], True),
			"+" UseKey["J"], (K) => LangSeparatedKey(K, ["lat_c_let_j", "lat_s_let_j"], SlotMod("J"), True, True),
			UseKey["K"], (K) => LangSeparatedKey(K, ["lat_c_let_k", "lat_s_let_k"], Slots["K"], True),
			"+" UseKey["K"], (K) => LangSeparatedKey(K, ["lat_c_let_k", "lat_s_let_k"], SlotMod("K"), True, True),
			UseKey["L"], (K) => LangSeparatedKey(K, ["lat_c_let_l", "lat_s_let_l"], Slots["L"], True),
			"+" UseKey["L"], (K) => LangSeparatedKey(K, ["lat_c_let_l", "lat_s_let_l"], SlotMod("L"), True, True),
			UseKey["M"], (K) => LangSeparatedKey(K, ["lat_c_let_m", "lat_s_let_m"], Slots["M"], True),
			"+" UseKey["M"], (K) => LangSeparatedKey(K, ["lat_c_let_m", "lat_s_let_m"], SlotMod("M"), True, True),
			UseKey["N"], (K) => LangSeparatedKey(K, ["lat_c_let_n", "lat_s_let_n"], Slots["N"], True),
			"+" UseKey["N"], (K) => LangSeparatedKey(K, ["lat_c_let_n", "lat_s_let_n"], SlotMod("N"), True, True),
			UseKey["O"], (K) => LangSeparatedKey(K, ["lat_c_let_o", "lat_s_let_o"], Slots["O"], True),
			"+" UseKey["O"], (K) => LangSeparatedKey(K, ["lat_c_let_o", "lat_s_let_o"], SlotMod("O"), True, True),
			UseKey["P"], (K) => LangSeparatedKey(K, ["lat_c_let_p", "lat_s_let_p"], Slots["P"], True),
			"+" UseKey["P"], (K) => LangSeparatedKey(K, ["lat_c_let_p", "lat_s_let_p"], SlotMod("P"), True, True),
			UseKey["Q"], (K) => LangSeparatedKey(K, ["lat_c_let_q", "lat_s_let_q"], Slots["Q"], True),
			"+" UseKey["Q"], (K) => LangSeparatedKey(K, ["lat_c_let_q", "lat_s_let_q"], SlotMod("Q"), True, True),
			UseKey["R"], (K) => LangSeparatedKey(K, ["lat_c_let_r", "lat_s_let_r"], Slots["R"], True),
			"+" UseKey["R"], (K) => LangSeparatedKey(K, ["lat_c_let_r", "lat_s_let_r"], SlotMod("R"), True, True),
			UseKey["S"], (K) => LangSeparatedKey(K, ["lat_c_let_s", "lat_s_let_s"], Slots["S"], True),
			"+" UseKey["S"], (K) => LangSeparatedKey(K, ["lat_c_let_s", "lat_s_let_s"], SlotMod("S"), True, True),
			UseKey["T"], (K) => LangSeparatedKey(K, ["lat_c_let_t", "lat_s_let_t"], Slots["T"], True),
			"+" UseKey["T"], (K) => LangSeparatedKey(K, ["lat_c_let_t", "lat_s_let_t"], SlotMod("T"), True, True),
			UseKey["U"], (K) => LangSeparatedKey(K, ["lat_c_let_u", "lat_s_let_u"], Slots["U"], True),
			"+" UseKey["U"], (K) => LangSeparatedKey(K, ["lat_c_let_u", "lat_s_let_u"], SlotMod("U"), True, True),
			UseKey["V"], (K) => LangSeparatedKey(K, ["lat_c_let_v", "lat_s_let_v"], Slots["V"], True),
			"+" UseKey["V"], (K) => LangSeparatedKey(K, ["lat_c_let_v", "lat_s_let_v"], SlotMod("V"), True, True),
			UseKey["W"], (K) => LangSeparatedKey(K, ["lat_c_let_w", "lat_s_let_w"], Slots["W"], True),
			"+" UseKey["W"], (K) => LangSeparatedKey(K, ["lat_c_let_w", "lat_s_let_w"], SlotMod("W"), True, True),
			UseKey["X"], (K) => LangSeparatedKey(K, ["lat_c_let_x", "lat_s_let_x"], Slots["X"], True),
			"+" UseKey["X"], (K) => LangSeparatedKey(K, ["lat_c_let_x", "lat_s_let_x"], SlotMod("X"), True, True),
			UseKey["Y"], (K) => LangSeparatedKey(K, ["lat_c_let_y", "lat_s_let_y"], Slots["Y"], True),
			"+" UseKey["Y"], (K) => LangSeparatedKey(K, ["lat_c_let_y", "lat_s_let_y"], SlotMod("Y"), True, True),
			UseKey["Z"], (K) => LangSeparatedKey(K, ["lat_c_let_z", "lat_s_let_z"], Slots["Z"], True),
			"+" UseKey["Z"], (K) => LangSeparatedKey(K, ["lat_c_let_z", "lat_s_let_z"], SlotMod("Z"), True, True),
			;
			UseKey["Comma"], (K) => LangSeparatedKey(K, "kkey_comma", Slots[","], True),
			"+" UseKey["Comma"], (K) => LangSeparatedKey(K, "kkey_lessthan", SlotMod(","), True, True),
			UseKey["Dot"], (K) => LangSeparatedKey(K, "kkey_dot", Slots["."], True),
			"+" UseKey["Dot"], (K) => LangSeparatedKey(K, "kkey_greaterthan", SlotMod("."), True, True),
			UseKey["Semicolon"], (K) => LangSeparatedKey(K, "kkey_semicolon", Slots[";"], True),
			"+" UseKey["Semicolon"], (K) => LangSeparatedKey(K, "kkey_colon", SlotMod(";"), True, True),
			UseKey["Apostrophe"], (K) => LangSeparatedKey(K, "kkey_apostrophe", Slots["'"], True),
			"+" UseKey["Apostrophe"], (K) => LangSeparatedKey(K, "kkey_quotation", SlotMod("'"), True, True),
			UseKey["LSquareBracket"], (K) => LangSeparatedKey(K, "kkey_l_square_bracket", Slots["["], True),
			"+" UseKey["LSquareBracket"], (K) => LangSeparatedKey(K, "kkey_l_curly_bracket", SlotMod("["), True, True),
			UseKey["RSquareBracket"], (K) => LangSeparatedKey(K, "kkey_r_square_bracket", Slots["]"], True),
			"+" UseKey["RSquareBracket"], (K) => LangSeparatedKey(K, "kkey_r_curly_bracket", SlotMod("]"), True, True),
			UseKey["Equals"], (K) => LangSeparatedKey(K, "kkey_equals", Slots["="], True),
			"+" UseKey["Equals"], (K) => LangSeparatedKey(K, "kkey_plus", SlotMod("="), True, True),
			UseKey["Minus"], (K) => LangSeparatedKey(K, "kkey_hyphen_minus", Slots["-"], True),
			"+" UseKey["Minus"], (K) => LangSeparatedKey(K, "kkey_underscore", SlotMod("-"), True, True),
			UseKey["Tilde"], (K) => LangSeparatedKey(K, "kkey_grave_accent", Slots["~"], True),
			"+" UseKey["Tilde"], (K) => LangSeparatedKey(K, "kkey_tilde", SlotMod("~"), True, True),
			UseKey["Slash"], (K) => LangSeparatedKey(K, "kkey_slash", Slots["/"], True),
			"+" UseKey["Slash"], (K) => LangSeparatedKey(K, "question", SlotMod("/"), True, True),
			UseKey["Backslash"], (K) => LangSeparatedKey(K, "kkey_backslash", Slots["\"], True),
			"+" UseKey["Backslash"], (K) => LangSeparatedKey(K, "kkey_verticalline", SlotMod("\"), True, True),
