...
GetKeyBindings(UseKey, Combinations := "FastKeys") {
  ...
  if Combinations = "FastKeys" {
    ...
    LayoutArray := [
      ...
      "<^>!" UseKey["C"], (K) => LangSeparatedKey(K, "", SlotMod("B", "<^>!"), True),
      "<^>!<!" UseKey["C"], (K) => LangSeparatedKey(K, "medieval_c", SlotMod("B", "<^>!<!"), True),
      ...
      "<+" UseKey["E"], (K) => LangSeparatedKey(K, "futhork_ear", SlotMod("D", "<+"), True),
      "<^>!" UseKey["E"], (K) => LangSeparatedKey(K, "futhark_younger_later_e", SlotMod("D", "<^>!"), True),
      "<^>!<!" UseKey["E"], (K) => LangSeparatedKey(K, "medieval_en", SlotMod("D", "<^>!<!"), True),
