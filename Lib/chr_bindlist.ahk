	...
	"Common", Map(
		...
		"Moded", Map(
			...
			"I", Map("<!", ["lat_c_let_i__acute", "lat_s_let_i__acute"],
				...
				"<^>!<+>+", ["lat_c_let_i__tilde", "lat_s_let_i__tilde"],
			...
			"N", Map("<!", ["lat_c_let_n__acute", "lat_s_let_n__acute"],
				"<^>!", ["lat_c_let_n__tilde", "lat_s_let_n__tilde"],
			...
			"O", Map("<!", ["lat_c_let_o__acute", "lat_s_let_o__acute"],
				...
				"<^>!<+>+", ["lat_c_let_o__tilde", "lat_s_let_o__tilde"],
			...
			"U", Map(
				...
				"<^>!<+>+", ["lat_c_let_u__tilde", "lat_s_let_u__tilde"],
			...
			"V", Map(
				...
				"<^>!<+>+", ["lat_c_let_v__tilde", "lat_s_let_v__tilde"]),
			...
			"Y", Map("<!", ["lat_c_let_y_acute", "lat_s_let_y_acute"],
				...
				"<^>!<+>+", ["lat_c_let_y__tilde", "lat_s_let_y__tilde"],
