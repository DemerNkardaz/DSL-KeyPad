...
**Дополнительно:** утилита автоматически читает любые «\*.XCompose» файлы в поддиректории «\User\» и создает рецепты из них. Однако это работает только в отношении последовательностей простых символов. «Мёртвые клавиши» и подобное не поддерживается.
