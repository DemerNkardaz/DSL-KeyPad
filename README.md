...
Утилита не гарантирует корректную работу с системными раскладками, отличающимися от стандартных QWERTY/ЙЦУКЕН. Тем не менее, в ней предусмотрена возможность выбора внутренней (эмулируемой) раскладки из следующих предустановленных вариантов:
