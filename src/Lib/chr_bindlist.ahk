bindingMaps := Map(
	...
	"Script Specified", Map(
		...
		"Old Hungarian", Map(
			"ForceSingle", True,
			"Flat", Map(
				"A", "hungarian_[c,s]_let_a",
				"B", "hungarian_[c,s]_let_eb",
				"C", "hungarian_[c,s]_let_ec",
				"D", "hungarian_[c,s]_let_ed",
				"E", "hungarian_[c,s]_let_e",
				"F", "hungarian_[c,s]_let_ef",
				"G", "hungarian_[c,s]_let_eg",
				"H", "hungarian_[c,s]_let_eh",
				"I", "hungarian_[c,s]_let_i",
				"J", "hungarian_[c,s]_let_ej",
				"K", "hungarian_[c,s]_let_ek",
				"L", "hungarian_[c,s]_let_el",
				"M", "hungarian_[c,s]_let_em",
				"N", "hungarian_[c,s]_let_en",
				"O", "hungarian_[c,s]_let_o",
				"P", "hungarian_[c,s]_let_ep",
				"Q", "",
				"R", "hungarian_[c,s]_let_er",
				"S", "hungarian_[c,s]_let_es",
				"T", "hungarian_[c,s]_let_et",
				"U", "hungarian_[c,s]_let_u",
				"V", "hungarian_[c,s]_let_ev",
				"W", "",
				"X", "",
				"Y", "hungarian_[c,s]_let_ue",
				"Z", "hungarian_[c,s]_let_ez",
				"1", "hungarian_num_one",
			...
			"Moded", Map(
				"A", Map("<^>!", "hungarian_[c,s]_let_aa"),
				"B", Map("<+", "hungarian_[c,s]_let_amb"),
				"C", Map(
					"<^>!", "hungarian_[c,s]_let_ecs",
					"<+", "hungarian_[c,s]_let_ech"
				),
				"E", Map(
					"<^>!", "hungarian_[c,s]_let_ee",
					"<+", "hungarian_[c,s]_let_enk"
				),
				"G", Map("<^>!", "hungarian_[c,s]_let_egy"),
				"I", Map("<^>!", "hungarian_[c,s]_let_ii"),
				"K", Map(
					"<^>!", "hungarian_[c,s]_let_ak",
					"<+", "hungarian_[c,s]_let_unk"
				),
				"L", Map("<^>!", "hungarian_[c,s]_let_ely"),
				"N", Map("<^>!", "hungarian_[c,s]_let_eny"),
				"O", Map(
					"<^>!", "hungarian_[c,s]_let_oo",
					"<+", "hungarian_[c,s]_let_oe",
					"<^>!<+", "hungarian_[c,s]_let_oe_nik",
					">+", "hungarian_[c,s]_let_oee"
				),
				"P", Map("<+", "hungarian_[c,s]_let_emp"),
				"R", Map("<+", "hungarian_[c,s]_let_short_er"),
				"S", Map(
					"<^>!", "hungarian_[c,s]_let_esz",
					"<+", "hungarian_[c,s]_let_us"
				),
				"T", Map(
					"<^>!", "hungarian_[c,s]_let_ety",
					"<+", "hungarian_[c,s]_let_ent",
					">+", "hungarian_[c,s]_let_ent_shaped"
				),
				"U", Map("<^>!", "hungarian_[c,s]_let_uu"),
				"Y", Map("<^>!", "hungarian_[c,s]_let_ue_nik"),
				"Z", Map("<^>!", "hungarian_[c,s]_let_ezs"),
			),
		),
		"Old Italic", Map(
			"ForceSingle", True,
		...
		"Shavian", Map(
			"ForceSingle", True,
			"Flat", Map(
				"A", "shavian_[n]_let_a_ash",
				"B", "shavian_[n]_let_b_bib",
				"C", "shavian_[n]_let_c_church",
				"D", "shavian_[n]_let_d_dead",
				"E", "shavian_[n]_let_e_egg",
				"F", "shavian_[n]_let_f_fee",
				"G", "shavian_[n]_let_g_gag",
				"H", "shavian_[n]_let_h_ha_ha",
				"I", "shavian_[n]_let_i_if",
				"J", "shavian_[n]_let_j_judge",
				"K", "shavian_[n]_let_k_kick",
				"L", "shavian_[n]_let_l_loll",
				"M", "shavian_[n]_let_m_mime",
				"N", "shavian_[n]_let_n_nun",
				"O", "shavian_[n]_let_o_on",
				"P", "shavian_[n]_let_p_peep",
				"Q", "",
				"R", "shavian_[n]_let_r_roar",
				"S", "shavian_[n]_let_s_so",
				"T", "shavian_[n]_let_t_tot",
				"U", "shavian_[n]_let_u_wool",
				"V", "shavian_[n]_let_v_vow",
				"W", "shavian_[n]_let_y_yea",
				"X", "",
				"Y", "shavian_[n]_let_w_woe",
				"Z", "shavian_[n]_let_z_zoo",
			),
			"Moded", Map(
				"A", Map(
