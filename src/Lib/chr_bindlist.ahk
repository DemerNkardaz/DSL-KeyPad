	...
	"Script Specified", Map(
		"Hellenic", Map(
			"Flat", Map(
				...
				"C:Caps", ["hel_[c,s]_let_g_gamma"],
				"D:Caps", ["hel_[c,s]_let_d_delta"],
				"E:Caps", ["hel_[c,s]_let_e_epsilon"],
				"F:Caps", ["hel_[c,s]_let_f_phi"],
				"G:Caps", ["hel_[c,s]_let_g_gamma"],
				"H:Caps", ["hel_[c,s]_let_h_eta"],
				"I:Caps", ["hel_[c,s]_let_i_iota"],
				"J:Caps", [""],
				"K:Caps", ["hel_[c,s]_let_k_kappa"],
				"L:Caps", ["hel_[c,s]_let_l_lambda"],
				"M:Caps", ["hel_[c,s]_let_m_mu"],
				"N:Caps", ["hel_[c,s]_let_n_nu"],
				"O:Caps", ["hel_[c,s]_let_o_omicron"],
				"P:Caps", ["hel_[c,s]_let_p_pi"],
				"Q:Caps", ["hel_[c,s]_let_q_koppa_archaic"],
				"R:Caps", ["hel_[c,s]_let_r_rho"],
				"S:Caps", ["hel_[c,s]_let_s_sigma"],
				"T:Caps", ["hel_[c,s]_let_t_tau"],
				"U:Caps", ["hel_[c,s]_let_u_upsilon"],
				"V:Caps", [""],
				"W:Caps", [""],
				"X:Caps", ["hel_[c,s]_let_x_xi"],
				"Y:Caps", [""],
				"Z:Caps", ["hel_[c,s]_let_z_zeta"],
			),
			"Moded", Map(
				"H", Map("<^>!:Caps", ["hel_[c,s]_let_h_chi"]),
				"O", Map("<^>!:Caps", ["hel_[c,s]_let_o_omega"]),
				"P", Map("<^>!:Caps", ["hel_[c,s]_let_p_psi"]),
				"Q", Map("<^>!:Caps", ["hel_[c,s]_let_q_koppa"]),
				"S", Map("<^>!:Caps", ["hel_s_let_s_sigma_final"]),
				"T", Map("<^>!:Caps", ["hel_[c,s]_let_t_theta"]),
			)
		),
		"Germanic Runes", Map(
			"Flat", Map(
		...
		"Old Turkic", Map(
			...
			"Moded", Map(
				"A", Map(
					"<^>!", ["turkic_yenisei_ae"],
					"<!", ["turkic_yenisei_ash", "turkic_orkhon_ash"]
				),
				...
				"N", Map(
					"<^>!>+", ["turkic_yenisei_ent", "turkic_orkhon_ent"],
					"<^>!", ["turkic_yenisei_aen", "turkic_orkhon_aen"],
					">+", ["turkic_yenisei_enc", "turkic_orkhon_enc"],
					">+", ["turkic_yenisei_eny", "turkic_orkhon_eny"],
					"<!", ["turkic_orkhon_eng"]
				),
				"O", Map("<^>!", ["turkic_yenisei_oe", "turkic_orkhon_oe"]),
				"P", Map("<!", ["turkic_orkhon_op"]),
				"Q", Map(
					"<^>!", ["turkic_yenisei_oek", "turkic_orkhon_oek"],
					"<!", ["turkic_yenisei_iq", "turkic_orkhon_iq"]
				),
				"R", Map(
					"<^>!", ["turkic_orkhon_aer"],
					"<!", ["turkic_orkhon_bash"]
				...
				"S", Map(
					"<^>!", ["turkic_orkhon_aes"],
					"<!", ["turkic_yenisei_esh", "turkic_orkhon_esh"]
				),
				"T", Map(
					"<^>!", ["turkic_yenisei_aet", "turkic_orkhon_aet"],
					"<^>!>+", ["turkic_orkhon_elt"],
					"<!", ["turkic_orkhon_ot"]
				),
		...
		"Old Hungarian", Map(
			"Flat", Map(
				...
				"C:Caps", ["hungarian_[c,s]_let_ec"],
				"D:Caps", ["hungarian_[c,s]_let_ed"],
				"E:Caps", ["hungarian_[c,s]_let_e"],
				"F:Caps", ["hungarian_[c,s]_let_ef"],
				"G:Caps", ["hungarian_[c,s]_let_eg"],
				"H:Caps", ["hungarian_[c,s]_let_eh"],
				"I:Caps", ["hungarian_[c,s]_let_i"],
				"J:Caps", ["hungarian_[c,s]_let_ej"],
				"K:Caps", ["hungarian_[c,s]_let_ek"],
				"L:Caps", ["hungarian_[c,s]_let_el"],
				"M:Caps", ["hungarian_[c,s]_let_em"],
				"N:Caps", ["hungarian_[c,s]_let_en"],
				"O:Caps", ["hungarian_[c,s]_let_o"],
				"P:Caps", ["hungarian_[c,s]_let_ep"],
				"Q:Caps", [""],
				"R:Caps", ["hungarian_[c,s]_let_er"],
				"S:Caps", ["hungarian_[c,s]_let_es"],
				"T:Caps", ["hungarian_[c,s]_let_et"],
				"U:Caps", ["hungarian_[c,s]_let_u"],
				"V:Caps", ["hungarian_[c,s]_let_ev"],
				"W:Caps", [""],
				"X:Caps", [""],
				"Y:Caps", ["hungarian_[c,s]_let_ue"],
				"Z:Caps", ["hungarian_[c,s]_let_ez"],
				"1", "hungarian_num_one",
			...
			"Moded", Map(
				"A", Map("<^>!:Caps", ["hungarian_[c,s]_let_aa"]),
				"B", Map("<+:Caps", ["hungarian_[c,s]_let_amb"]),
				"C", Map(
					"<^>!:Caps", ["hungarian_[c,s]_let_ecs"],
					"<+:Caps", ["hungarian_[c,s]_let_ech"]
				),
				"E", Map(
					"<^>!:Caps", ["hungarian_[c,s]_let_ee"],
					"<+:Caps", ["hungarian_[c,s]_let_enk"]
				),
				"G", Map("<^>!:Caps", ["hungarian_[c,s]_let_egy"]),
				"I", Map("<^>!:Caps", ["hungarian_[c,s]_let_ii"]),
				"K", Map(
					"<^>!:Caps", ["hungarian_[c,s]_let_ak"],
					"<+:Caps", ["hungarian_[c,s]_let_unk"]
				),
				"L", Map("<^>!:Caps", ["hungarian_[c,s]_let_ely"]),
				"N", Map("<^>!:Caps", ["hungarian_[c,s]_let_eny"]),
				"O", Map(
					"<^>!:Caps", ["hungarian_[c,s]_let_oo"],
					"<+:Caps", ["hungarian_[c,s]_let_oe"],
					"<^>!<+:Caps", ["hungarian_[c,s]_let_oe_nik"],
					">+:Caps", ["hungarian_[c,s]_let_oee"]
				),
				"P", Map("<+:Caps", ["hungarian_[c,s]_let_emp"]),
				"R", Map("<+:Caps", ["hungarian_[c,s]_let_short_er"]),
				"S", Map(
					"<^>!:Caps", ["hungarian_[c,s]_let_esz"],
					"<+:Caps", ["hungarian_[c,s]_let_us"]
				),
				"T", Map(
					"<^>!:Caps", ["hungarian_[c,s]_let_ety"],
					"<+:Caps", ["hungarian_[c,s]_let_ent"],
					">+:Caps", ["hungarian_[c,s]_let_ent_shaped"]
				),
				"U", Map("<^>!:Caps", ["hungarian_[c,s]_let_uu"]),
				"Y", Map("<^>!:Caps", ["hungarian_[c,s]_let_ue_nik"]),
				"Z", Map("<^>!:Caps", ["hungarian_[c,s]_let_ezs"]),
			),
		),
		"Old Italic", Map(
			"Flat", Map(
		...
		"Ancient South Arabian", Map(
			...
			"Moded", Map(
				...
				"S", Map(
					...
					">+", "south_arabian_let_shin", "<+", "south_arabian_let_samekh"
				),
				"T", Map(
		...
		"Ancient North Arabian", Map(
			...
			"Moded", Map(
				...
				"S", Map(
					...
					">+", "north_arabian_let_es_2", "<+", "north_arabian_let_es_3"
				),
				"T", Map(
