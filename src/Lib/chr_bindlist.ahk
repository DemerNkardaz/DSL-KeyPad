		...
		"Old Persian", Map(
			...
			"Flat", Map(
				"A", (K) => BindHandler.TimeSend(K, Map(),
					(*) => BindHandler.Send(K, "old_persian_n_sign_a"), "0.005"),
				...
				"I", (K) => BindHandler.TimeSend(K, Map(),
					(*) => BindHandler.Send(K, "old_persian_n_sign_i"), "0.005"),
				...
				"U", (K) => BindHandler.TimeSend(K, Map(),
					(*) => BindHandler.Send(K, "old_persian_n_sign_u"), "0.005"),
