bindingMaps := Map(
	...
	"Script Specified", Map(
		...
		"IPA", Map(
			"ForceSingle", True,
			"Flat", Map(
				"A:Caps", ["lat_s_let_a_alpha"],
				"B:Caps", [""],
				"C:Caps", ["lat_s_let_c__curl"],
				"D:Caps", ["lat_s_let_d_eth"],
				"E:Caps", ["lat_s_let_e_epsilon"],
				"F:Caps", ["lat_s_let_f_phi"],
				"G:Caps", ["lat_s_let_g_gamma"],
				"H:Caps", [""],
				"I:Caps", ["lat_c_let_i::smallCapital"],
				"J:Caps", [""],
				"K:Caps", [""],
				"L:Caps", [""],
				"M:Caps", [""],
				"N:Caps", [""],
				"O:Caps", ["lat_s_let_o_rams_horn"],
				"P:Caps", [""],
				"Q:Caps", [""],
				"R:Caps", [""],
				"S:Caps", ["lat_s_let_s_sigma"],
				"T:Caps", [""],
				"U:Caps", ["lat_s_let_u_upsilon"],
				"V:Caps", [""],
				"W:Caps", [""],
				"X:Caps", [""],
				"Y:Caps", [""],
				"Z:Caps", ["lat_s_let_z_ezh"],
