	...
	"Script Specified", Map(
		...
		"Cypriot Syllabary", Map(
			...
			"Flat", Map(
				...
				"J", "",
				"K", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_k_ka"),
					"E", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_k_ke"),
					"I", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_k_ki"),
					"O", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_k_ko"),
					"U", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_k_ku"),
				), (*) => [], "1", True),
				"L", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_l_la"),
					"E", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_l_le"),
					"I", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_l_li"),
					"O", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_l_lo"),
					"U", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_l_lu"),
				), (*) => [], "1", True),
				"M", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_m_ma"),
					"E", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_m_me"),
					"I", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_m_mi"),
					"O", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_m_mo"),
					"U", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_m_mu"),
				), (*) => [], "1", True),
				"N", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_n_na"),
					"E", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_n_ne"),
					"I", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_n_ni"),
					"O", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_n_no"),
					"U", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_n_nu"),
				), (*) => [], "1", True),
				"O", BindHandler.TimeShell("cypriot_syllabary_n_syl_o"),
				"P", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_p_pa"),
					"E", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_p_pe"),
					"I", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_p_pi"),
					"O", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_p_po"),
					"U", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_p_pu"),
				), (*) => [], "1", True),
				"Q", "",
				"R", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_r_ra"),
					"E", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_r_re"),
					"I", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_r_ri"),
					"O", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_r_ro"),
					"U", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_r_ru"),
				), (*) => [], "1", True),
				"S", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_s_sa"),
					"E", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_s_se"),
					"I", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_s_si"),
					"O", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_s_so"),
					"U", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_s_su"),
				), (*) => [], "1", True),
				"T", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_t_ta"),
					"E", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_t_te"),
					"I", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_t_ti"),
					"O", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_t_to"),
					"U", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_t_tu"),
				), (*) => [], "1", True),
				"U", BindHandler.TimeShell("cypriot_syllabary_n_syl_u"),
				"V", "",
				"W", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_w_wa"),
					"E", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_w_we"),
					"I", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_w_wi"),
					"O", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_w_wo"),
				), (*) => [], "1", True),
				"X", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_x_xa"),
					"E", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_x_xe"),
				), (*) => [], "1", True),
				"Y", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_y_ja"),
					"O", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_y_jo"),
				), (*) => [], "1", True),
				"Z", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_z_za"),
					"O", (*) => BindHandler.Send(K, "cypriot_syllabary_n_syl_z_zo"),
				), (*) => [], "1", True),
			),
			"Moded", Map()
		),
		...
		"Old Persian", Map(
			...
			"Flat", Map(
				...
				"D", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "old_persian_n_sign_d_da"),
					"I", (*) => BindHandler.Send(K, "old_persian_n_sign_d_di"),
					"U", (*) => BindHandler.Send(K, "old_persian_n_sign_d_du"),
				), (*) => [], "1", True),
				"E", "",
				"F", "old_persian_n_sign_f_fa",
				"G", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "old_persian_n_sign_g_ga"),
					"U", (*) => BindHandler.Send(K, "old_persian_n_sign_g_gu"),
				), (*) => [], "1", True),
				"H", "old_persian_n_sign_h_ha",
				"I", BindHandler.TimeShell("old_persian_n_sign_i"),
				"J", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "old_persian_n_sign_j_ja"),
					"I", (*) => BindHandler.Send(K, "old_persian_n_sign_j_ji"),
				), (*) => [], "1", True),
				"K", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "old_persian_n_sign_k_ka"),
					"I", (*) => BindHandler.Send(K, "old_persian_n_sign_k_ka"),
					"U", (*) => BindHandler.Send(K, "old_persian_n_sign_k_ku"),
				), (*) => [], "1", True),
				"L", "old_persian_n_sign_l_la",
				"M", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "old_persian_n_sign_m_ma"),
					"I", (*) => BindHandler.Send(K, "old_persian_n_sign_m_mi"),
					"U", (*) => BindHandler.Send(K, "old_persian_n_sign_m_mu"),
				), (*) => [], "1", True),
				"N", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "old_persian_n_sign_n_na"),
					"I", (*) => BindHandler.Send(K, "old_persian_n_sign_n_na"),
					"U", (*) => BindHandler.Send(K, "old_persian_n_sign_n_nu"),
				), (*) => [], "1", True),
				"O", "",
				"P", "old_persian_n_sign_p_pa",
				"Q", "",
				"R", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "old_persian_n_sign_r_ra"),
					"I", (*) => BindHandler.Send(K, "old_persian_n_sign_r_ra"),
					"U", (*) => BindHandler.Send(K, "old_persian_n_sign_r_ru"),
				), (*) => [], "1", True),
				"S", "old_persian_n_sign_s_sa",
				"T", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "old_persian_n_sign_t_ta"),
					"I", (*) => BindHandler.Send(K, "old_persian_n_sign_t_ta"),
					"U", (*) => BindHandler.Send(K, "old_persian_n_sign_t_tu"),
				), (*) => [], "1", True),
				"U", BindHandler.TimeShell("old_persian_n_sign_u"),
				"V", (K) => BindHandler.TimeSend(K, Map(
					"A", (*) => BindHandler.Send(K, "old_persian_n_sign_v_va"),
					"I", (*) => BindHandler.Send(K, "old_persian_n_sign_v_vi"),
				), (*) => [], "1", True),
				"W", "",
