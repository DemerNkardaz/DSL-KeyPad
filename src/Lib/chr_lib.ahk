...
LibRegistrate(this) {
	...
	rawEntries := [
		...
		"[left,right,left_double,right_double,top,bottom,top_double,bottom_double]_cjk_title_bracket", {
			...
			tags: [
				["cjk title left bracket", "левая заголовочная кавычка"],
				["cjk title right bracket", "правая заголовочная кавычка"],
				["cjk title left double bracket", "левая двойная заголовочная кавычка"],
				["cjk title right double bracket", "правая двойная заголовочная кавычка"],
				["cjk title top bracket", "верхняя заголовочная кавычка"],
				["cjk title bottom bracket", "нижняя заголовочная кавычка"],
				["cjk title top double bracket", "верхняя двойная заголовочная кавычка"],
				["cjk title bottom double bracket", "нижняя двойная заголовочная кавычка"],
			],
