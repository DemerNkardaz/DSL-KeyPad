Class Dev {
	...
	static CreateWorkflowScript() {
		...
		messageParts := (
			...
			'			<td>`n'
			'				<img src="https://www.autohotkey.com/favicon.ico" width="16" style="vertical-align:middle;">&emsp14;<a href="https://www.autohotkey.com/download/ahk-v2.exe">AutoHotkey v2.^</a><br>`n'
			'				Windows 10/11 x64`n'
			'			</td>`n'
			'		</tr>`n'
			'		<tr>`n'
			...
			'			<td>`n'
			'				<img src="https://www.gstatic.com/images/icons/material/apps/fonts/1x/catalog/v5/favicon.svg" width="16" style="vertical-align:middle;">&emsp14;<a href="https://fonts.google.com/?query=noto">Noto fonts (search)</a><br>`n'
			'				<img src="https://www.kurinto.com/favicon.ico" width="16" style="vertical-align:middle;">&emsp14;<a href="https://www.kurinto.com/download.htm">Kurinto fonts</a>`n'
			'				<details>`n'
