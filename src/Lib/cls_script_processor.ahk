Class InputScriptProcessor {
	...
	static locLib := {
		lat: {
			c: {
				a_acu: ChrLib.Get("lat_c_let_a__acute"),
				a_bre: ChrLib.Get("lat_c_let_a__breve"),
				a_bre_acu: ChrLib.Get("lat_c_let_a__breve__acute"),
				a_bre_gra: ChrLib.Get("lat_c_let_a__breve__grave"),
				a_bre_til: ChrLib.Get("lat_c_let_a__breve__tilde_above"),
				a_bre_dot_bel: ChrLib.Get("lat_c_let_a__breve__dot_below"),
				a_bre_hoo_abo: ChrLib.Get("lat_c_let_a__breve__hook_above"),
				a_cir: ChrLib.Get("lat_c_let_a__circumflex"),
				a_cir_acu: ChrLib.Get("lat_c_let_a__circumflex__acute"),
				a_cir_gra: ChrLib.Get("lat_c_let_a__circumflex__grave"),
				a_cir_til: ChrLib.Get("lat_c_let_a__circumflex__tilde_above"),
				a_cir_dot_bel: ChrLib.Get("lat_c_let_a__circumflex__dot_below"),
				a_cir_hoo_abo: ChrLib.Get("lat_c_let_a__circumflex__hook_above"),
				a_gra: ChrLib.Get("lat_c_let_a__grave"),
				a_til: ChrLib.Get("lat_c_let_a__tilde_above"),
				a_dot_bel: ChrLib.Get("lat_c_let_a__dot_below"),
				a_hoo_abo: ChrLib.Get("lat_c_let_a__hook_above"),
				;
				b_sto: ChrLib.Get("lat_c_let_b__stroke_short"),
				;
				d_sto: ChrLib.Get("lat_c_let_d__stroke_short"),
				;
				e_acu: ChrLib.Get("lat_c_let_e__acute"),
				e_bre: ChrLib.Get("lat_c_let_e__breve"),
				e_cir: ChrLib.Get("lat_c_let_e__circumflex"),
				e_cir_acu: ChrLib.Get("lat_c_let_e__circumflex__acute"),
				e_cir_gra: ChrLib.Get("lat_c_let_e__circumflex__grave"),
				e_cir_til: ChrLib.Get("lat_c_let_e__circumflex__tilde_above"),
				e_cir_dot_bel: ChrLib.Get("lat_c_let_e__circumflex__dot_below"),
				e_cir_hoo_abo: ChrLib.Get("lat_c_let_e__circumflex__hook_above"),
				e_gra: ChrLib.Get("lat_c_let_e__grave"),
				e_til: ChrLib.Get("lat_c_let_e__tilde_above"),
				e_dot_bel: ChrLib.Get("lat_c_let_e__dot_below"),
				e_hoo_abo: ChrLib.Get("lat_c_let_e__hook_above"),
			},
			s: {
				a_acu: ChrLib.Get("lat_s_let_a__acute"),
				a_bre: ChrLib.Get("lat_s_let_a__breve"),
				a_bre_acu: ChrLib.Get("lat_s_let_a__breve__acute"),
				a_bre_gra: ChrLib.Get("lat_s_let_a__breve__grave"),
				a_bre_til: ChrLib.Get("lat_s_let_a__breve__tilde_above"),
				a_bre_dot_bel: ChrLib.Get("lat_s_let_a__breve__dot_below"),
				a_bre_hoo_abo: ChrLib.Get("lat_s_let_a__breve__hook_above"),
				a_cir: ChrLib.Get("lat_s_let_a__circumflex"),
				a_cir_acu: ChrLib.Get("lat_s_let_a__circumflex__acute"),
				a_cir_gra: ChrLib.Get("lat_s_let_a__circumflex__grave"),
				a_cir_til: ChrLib.Get("lat_s_let_a__circumflex__tilde_above"),
				a_cir_dot_bel: ChrLib.Get("lat_s_let_a__circumflex__dot_below"),
				a_cir_hoo_abo: ChrLib.Get("lat_s_let_a__circumflex__hook_above"),
				a_gra: ChrLib.Get("lat_s_let_a__grave"),
				a_til: ChrLib.Get("lat_s_let_a__tilde_above"),
				a_dot_bel: ChrLib.Get("lat_s_let_a__dot_below"),
				a_hoo_abo: ChrLib.Get("lat_s_let_a__hook_above"),
				;
				b_sto: ChrLib.Get("lat_s_let_b__stroke_short"),
				;
				d_sto: ChrLib.Get("lat_s_let_d__stroke_short"),
				;
				e_acu: ChrLib.Get("lat_s_let_e__acute"),
				e_bre: ChrLib.Get("lat_s_let_e__breve"),
				e_cir: ChrLib.Get("lat_s_let_e__circumflex"),
				e_cir_acu: ChrLib.Get("lat_s_let_e__circumflex__acute"),
				e_cir_gra: ChrLib.Get("lat_s_let_e__circumflex__grave"),
				e_cir_til: ChrLib.Get("lat_s_let_e__circumflex__tilde_above"),
				e_cir_dot_bel: ChrLib.Get("lat_s_let_e__circumflex__dot_below"),
				e_cir_hoo_abo: ChrLib.Get("lat_s_let_e__circumflex__hook_above"),
				e_gra: ChrLib.Get("lat_s_let_e__grave"),
				e_til: ChrLib.Get("lat_s_let_e__tilde_above"),
				e_dot_bel: ChrLib.Get("lat_s_let_e__dot_below"),
				e_hoo_abo: ChrLib.Get("lat_s_let_e__hook_above"),
			},
		},
	}
		...
		if StrLen(input) > 0 && IPS.options.interceptionInputMode != "" {
			if !RegExMatch(input, forbiddenChars) {
				...
				if IPS.autoDiacritics || IPS.options.interceptionInputMode = "autoDiacritics" {
					...
					setAutoDiacritic := ChrCrafter.ValidateRecipes(intermediateValue, , True, ["Latin Accented", "Latin Ligature Accented", "Cyrillic Accented", "Diacritic Mark"])
